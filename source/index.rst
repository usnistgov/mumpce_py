...
`Download this software from GitHub <https://github.com/usnistgov/mumpce_py>`_
...
This software is subject to the `NIST Software License <https://www.nist.gov/director/licensing>`_ (revised as of July 2017). This license can be found in the GitHub repo in the file named LICENSE. 
