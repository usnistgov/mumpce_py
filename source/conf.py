# -*- coding: utf-8 -*-
#
# mumpce documentation build configuration file, created by
...
html_theme = 'agogo'
#html_style = 'https://pages.nist.gov/nist-header-footer/css/nist-combined.css'
html_style = 'agogo.css'
#html_style = 'NISTStyle.css'
...
html_title =  'MUM-PCE ' + version + ' documentation' #None

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'MUM-PCE'#None
...
latex_documents = [
    (master_doc, 'mumpce.tex', u'mumpce Documentation',
...
man_pages = [
    (master_doc, 'mumpce', u'mumpce Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mumpce', u'mumpce Documentation',
     author, 'mumpce', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {'cantera': ('http://cantera.org/docs/sphinx/html/', None)}
